...
function SingleEditProduct() {
      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <Link to={'/'} style={{textDecoration:"none"}}>    <li className="nav-item">
          ...
          <li className="nav-item">
            ...
            <Link to={'/product'}>  <span className="menu-title">Products</span></Link>
            </a>
          </li>
  ...
  <input className="custom-input" type="text" name='price' value={state.price} placeholder='Price' onChange={handleChange} />
...
<div className="custom-card">
  <img className="custom-card-img" src={state.img} alt={state.title} />
